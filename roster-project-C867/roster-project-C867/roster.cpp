...
void Roster::add(string row)
{
	if (lastIndex < capacity) {
		lastIndex++;
		int numDaysArray[Student::number_days_size];
...
void Roster::printDegree(DegreeType d)
{
	cout << "Student Roster by Degree: " << stringDegreeType[d] << "\n";
	for (int i = 0; i <= lastIndex; ++i) {
...
int main()
{
	...
	cout << "                     STUDENT Name and ID           " << endl << endl;
	cout << "               Brandon Petterborg - #001216266    " << endl << endl;
